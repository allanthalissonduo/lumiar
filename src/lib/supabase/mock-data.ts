...
export const MOCK_CONVERSATIONS = [
  { id: 'conv1', account_id: 'mock-account-id', contact_id: 'c1', status: 'open', assigned_to: null, last_message_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'conv2', account_id: 'mock-account-id', contact_id: 'c2', status: 'open', assigned_to: null, last_message_at: new Date(Date.now() - 3600000).toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
]

export const MOCK_MESSAGES = [
  { id: 'm1', conversation_id: 'conv1', direction: 'inbound', type: 'text', content: { text: 'Olá! Gostaria de saber mais sobre o produto.' }, status: 'delivered', created_at: new Date(Date.now() - 7200000).toISOString() },
  { id: 'm2', conversation_id: 'conv1', direction: 'outbound', type: 'text', content: { text: 'Claro! Posso te ajudar. Qual produto te interessa?' }, status: 'read', created_at: new Date(Date.now() - 3600000).toISOString() },
  { id: 'm3', conversation_id: 'conv1', direction: 'inbound', type: 'text', content: { text: 'Tenho interesse no plano Premium.' }, status: 'delivered', created_at: new Date(Date.now() - 1800000).toISOString() },
]
